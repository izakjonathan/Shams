      ...
      <body className="splashActive">
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `try{if(sessionStorage.getItem("shf-splash-seen-v2.1.4")==="1"){document.documentElement.classList.add("splashSessionSeen");document.documentElement.classList.remove("splashCanvasActive","splashRunwayActive");}}catch{}`,
          }}
        />
        <noscript>
          <style>{`
