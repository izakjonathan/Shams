...
export default async function AdminOverview() {
  ...
  return <>
    ...
    {database && <form action={seedDatabaseAction} className="adminSeed"><p>Seed or refresh database records from the v2.1.0 local baseline.</p><button type="submit">Seed database</button></form>}
